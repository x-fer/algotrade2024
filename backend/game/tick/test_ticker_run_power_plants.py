...
def test_run_power_plants_no_resource(get_tick_data, get_ticker, get_player):
...
def test_run_power_plants_heating_up(get_tick_data, get_ticker, get_player):
...
def test_run_power_plants_producing(get_tick_data, get_ticker, get_player):
    # player1 = get_player(money=1000, coal=1, energy=0)
    # player_dict = get_player_dict([player1])
...
def test_run_power_plants_renewable(get_tick_data, get_ticker, get_player):
